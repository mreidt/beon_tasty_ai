    ...
    def __init__(self, model_name="gpt-4o-mini", openai_api_key=None):
        ...
        self.prompt = ChatPromptTemplate.from_messages([
            ("system", (
                    ...
                    "emphasized. You should identify if the user is asking for a recipe based on the prompt. The user "
                    "can ask things like: i want a meal, i want a dessert, i want a dinner, and things like that. "
