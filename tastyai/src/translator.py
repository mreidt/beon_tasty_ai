    ...
    def __init__(self, openai_key, language="english"):
        ...
        self.prompt = ChatPromptTemplate.from_messages([
            ("system", (
                    ...
                    "translate text from english to spanish (and vice versa) and english to portuguese (and vice versa)"
                    f". Return the translated text in the following language: '''{self.language}'''. Return the "
                    "information as a simple text string."
                )
            ),
            ("human", "{query}")
        ])
